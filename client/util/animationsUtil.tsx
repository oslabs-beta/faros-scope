 ...
 * @returns void
 */
export function setArrayAnimationDelay(
 ...
 */
export function formatLettersAsSpans(text: string): ReactNode[] {
 ...
 * @returns void
 */
export function setArrayScale(elements: HTMLElement[], scale: number): void {
