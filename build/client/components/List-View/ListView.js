...
const ListView = ({ metricsObject }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: dataObj ? ((0, jsx_runtime_1.jsx)(TableContainer_1.default, { children: (0, jsx_runtime_1.jsxs)(Table_1.default, { sx: { minWidth: 500, bgcolor: 'secondary.main' }, "aria-label": "custom pagination table", children: [(0, jsx_runtime_1.jsxs)(TableHead_1.default, { children: [(0, jsx_runtime_1.jsx)(TableRow_1.default, { children: (0, jsx_runtime_1.jsx)(TableCell_1.default, { sx: { fontSize: 20, fontWeight: 'fontWeightBold' }, children: (_a = dataObj[0]) === null || _a === void 0 ? void 0 : _a.type[0].toUpperCase().concat(dataObj[0].type.slice(1)) }) }), (0, jsx_runtime_1.jsx)(TableRow_1.default, { sx: { bgcolor: 'primary.light' }, children: columns.map((column) => ((0, jsx_runtime_1.jsx)(TableCell_1.default, { align: column.align, style: { minWidth: column.minWidth }, children: column.label }, column.id))) })] }), (0, jsx_runtime_1.jsxs)(TableBody_1.default, { children: [(_b = (rowsPerPage > 0
