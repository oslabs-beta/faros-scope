...
const NotificationDisplay = () => {
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: `outerNotifContainer ${muiTheme.palette.mode}`, children: (0, jsx_runtime_1.jsxs)("div", { className: `notificationContainer ${muiTheme.palette.mode}`, children: [(0, jsx_runtime_1.jsx)("h2", { className: "notificationTitle", children: "Notifications" }), filteredLogHistory] }) }));
};
